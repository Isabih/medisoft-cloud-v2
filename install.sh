#!/usr/bin/env bash
# =========================================================
# Medisoft Guardian Cloud v1.2 Production Retention - cloud installer
...
APP_NAME=Medisoft Guardian Cloud v1.2 Production Retention
...
INCIDENT_HISTORY_RETENTION_DAYS=365
...
CHECK_TABLE_NAME=${CHECK_TABLE_NAME:-address}
CHECK_TIME_COLUMN=${CHECK_TIME_COLUMN:-updated_at}
EOF
...
cat > /etc/logrotate.d/medisoft-guardian <<'EOF'
/var/log/medisoft-guardian.log {
    daily
    rotate 7
    compress
    missingok
...
log "============================================================"
log "Medisoft Guardian Cloud v1.2 Production Retention installed."
