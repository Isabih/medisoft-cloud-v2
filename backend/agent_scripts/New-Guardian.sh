...
DEFAULT_BACKEND_URL="http://100.115.244.88"
...
def source_config():
    ...
    try:
        ...
        server_id = str(query_value(conn, "SHOW VARIABLES LIKE 'server_id'"))
        log_bin = str(query_value(conn, "SHOW VARIABLES LIKE 'log_bin'")).upper()
        binlog_format = str(query_value(conn, "SHOW VARIABLES LIKE 'binlog_format'")).upper()
        ...
        try:
            ...
            if repl:
                ...
                result.update({
                    "io_running": repl_row.get("Replica_IO_Running", "No"),
                    "sql_running": repl_row.get("Replica_SQL_Running", "No"),
                })
...
echo
echo "Monitoring:"
echo "curl ${API_BASE_URL}/api/v1/hybrid/centers/summary"
echo
echo "========================================================="
echo
